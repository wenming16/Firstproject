...
{
   uint8 Init_state;
   Init_state = Init_GPIO(port,name,1,state);    //初始化指示灯
   return(Init_state);
}
...
//***********************************继电器***************************************//
/*=======================================================================
 *函数名:      Relay_Init(uint16 port,uint8 name,uint8 state)
 *功能:        继电器初始化函数
 *参数:        无       
 *返回：       无
...
/*=======================================================================
 *函数名:      Relay_Control(uint16 port,uint8 name,uint8 state)
 *功能:        继电器控制函数
 *参数:        无       
 *返回：       无
...
/*=======================================================================
 *函数名:      Relay_StateGet(uint16 port,uint8 pin)
 *功能:        继电器状态获取
 *参数:        无       
 *返回：       无
