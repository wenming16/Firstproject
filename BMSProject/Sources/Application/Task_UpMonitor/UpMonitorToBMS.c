  ...
  { 
      ...
      switch(data -> m_data[0])
      {
        ...
        case 01:
          ...
          //g_BMSMonitor_Curr.Charge_Over3_Current =(*(uint16*)(0x0CFC));                               
        break;
        //SOC阈值
       /* case 02:
          Val8 = data -> m_data[1];   
      ...
      switch(data -> m_data[0])
      {
        ...
        case 02:
         ...
         /* Val8 = data -> m_data[4];                       //下标主负继电器
          if(Val8!=0xFF)
          {
            g_MonitorBMS_SOC.Monitor_BMS_Delay_T.Monitor_BMS_DelayBit.Relay_Negtive = Val8;  
          }
          Val8 = data -> m_data[5];                       //下标预充继电器
          if(Val8!=0xFF)
          {
            g_MonitorBMS_SOC.Monitor_BMS_Delay_T.Monitor_BMS_DelayBit.Relay_Precharge = Val8;  
          }
          Val8 = data -> m_data[6];                       //下标快充继电器
          if(Val8!=0xFF)
          {
            g_MonitorBMS_SOC.Monitor_BMS_Delay_T.Monitor_BMS_DelayBit.Relay_Charge = Val8;  
          }*/
      ...
      case 0x19FFF4C0:
      Send_ID = 0xFF;
      g_MonitorBMS_Start.Communication = data -> m_data[0];
      g_MonitorBMS_Start.CellMessageSend_judge = 0x01; 
      break;
  }
