...
uint8 ReadFltCodeFromEEE(uint8 read_flag,uint8 clear_flag)
{
    ...
    uint16 i;
    pCANFRAME  FltCodeBMSToUpmonitor=NULL;
...
void Task_FltCodeStore(void)
{
    ...
    readfault[1] = VoltSL(g_Flt_DisChg.Level_Volt_Sys_Low, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[2] = VoltCH(g_Flt_Charge.Level_Volt_Cell_High, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[3] = VoltCL(g_Flt_DisChg.Level_Volt_Cell_Low, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[4] = VoltCD(g_Flt_DisChg.Level_Volt_Cell_Diff_High, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[5] = CurrH_Charge(g_Flt_Charge.Level_Current_Charge_High, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[6] = CurrH_DisChg(g_Flt_DisChg.Level_Current_DisCharge_High, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[7] = TempH_DisChg(g_Flt_DisChg.Level_Temp_High, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[8] = TempH_Charge(g_Flt_Charge.Level_Temp_High, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[9] = TempL_DisChg(g_Flt_DisChg.Level_Temp_Low, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[10] = TempL_Charge(g_Flt_Charge.Level_Temp_Low, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[11] = TempD_DisChg(g_Flt_DisChg.Level_Temp_Diff_High, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[12] = TempD_Charge(g_Flt_Charge.Level_Temp_Diff_High, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[13] = InsulationNeg_Fault(g_IsoDetect.insulation_grade, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day, Read_IIC_Time.IIC_Read_Hour, Read_IIC_Time.IIC_Read_Minute); 
    
    readfault[14] = InsulationPos_Fault(g_IsoDetect.insulation_grade, Read_IIC_Time.IIC_Read_Year, Read_IIC_Time.IIC_Read_Month, Read_IIC_Time.IIC_Read_Day,Read_IIC_Time.IIC_Read_Hour,Read_IIC_Time.IIC_Read_Minute); 
