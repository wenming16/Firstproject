...
HeartBeat_T        HeartBeat;
 ...
 //放电故障判断
 static uint8 Fault_DisChg_VoltS(uint32 Volt,uint8 Temp); //放电总压低
 static uint8 Fault_DisChg_VoltC(uint16 Volt,uint8 Temp); //放电单体电压低
 ...
 //充电故障判断
 static uint8 Fault_Charge_VoltS(uint32 Volt);            //充电总压高
...
========================================================================*/ 
//判断故障等级
static uint8 Fault_Charge_TempD(uint8 T_Diff)  //输入单体最高/低电压
{
  static uint8 cnt[2];      //时间计数
  static uint8 FltL;
