...
/******************************************************************************/
#pragma CODE_SEG RAM_CODE
UINT16 PFlash_ReadWord (UINT32 destination) //读取2个字节
{
