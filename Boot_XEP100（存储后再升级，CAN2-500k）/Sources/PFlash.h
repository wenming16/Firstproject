...
#define FLASH_SECTOR_SIZE          0x400//Pflash一个扇区1K          

#define PFLASH_START               0x00700000//PFALSH的起始地址
#define PFLASH_PAGE_SIZE           0x4000    //一页16K
#define PFLASH_PAGE_START          0xC0      //PFLASH的起始页
#define PFLASH_PAGE_WINDOW_START   0x8000    //窗口的起始地址
...
#pragma CODE_SEG RAM_CODE
  ...
  extern UINT16 PFlash_ReadWord (UINT32 destination);
