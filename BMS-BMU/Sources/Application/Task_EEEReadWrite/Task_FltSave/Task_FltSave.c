...
void Task_FltCodeStore(void)
{
  ...
  readfault[13] = InsulationNeg_Fault(g_IsoDetect.insulation_grade, year, month, day, hour, min); 
  
  readfault[14] = InsulationPos_Fault(g_IsoDetect.insulation_grade, year, month, day,hour,min); 
